...
else ifeq ($(BR2_LINUX_KERNEL_CUSTOM_DIR),y)
LINUX_SITE = $(call qstrip,$(BR2_LINUX_KERNEL_CUSTOM_DIR_URL))
...
define LINUX_BUILD_CMDS
	...
	# We need to copy over our adjusted DTB
	cp -r  $(LINUX_SITE)/../../src/nw/arch/arm64/boot/dts/freescale/imx8mq-nitrogen8m.dts $(@D)/arch/arm64/boot/dts/freescale/imx8mq-nitrogen8m.dts

	# We also need to copy over our adjusted Ethernet driver parts
	cp -r  $(LINUX_SITE)/../../src/nw/drivers/net/ethernet/freescale/fec_helpers.h $(@D)/drivers/net/ethernet/freescale/fec_helpers.h
	cp -r  $(LINUX_SITE)/../../src/nw/drivers/net/ethernet/freescale/fec_main.c $(@D)/drivers/net/ethernet/freescale/fec_main.c
	cp -r  $(LINUX_SITE)/../../src/nw/drivers/net/ethernet/freescale/fec_ptp.c $(@D)/drivers/net/ethernet/freescale/fec_ptp.c
