...
LINUX_HEADERS_CUSTOM_DIR = $(call qstrip,$(BR2_LINUX_KERNEL_CUSTOM_DIR))
...
else ifeq ($(LINUX_HEADERS_CUSTOM_DIR),y)
LINUX_HEADERS_SITE = $(BR2_LINUX_KERNEL_CUSTOM_DIR_URL)
