...
#define BL31_BASE			U(0xA0000000)
#define BL31_LIMIT			U(0xA0200000)
...
#define IMX_NIC_BASE      U(0x30be0000)
#define IMX_NIC_SIZE      U(0x10000)

#define AIPS4_BASE U(0x32c00000)
#define AIPS4_SIZE U(0x400000)
